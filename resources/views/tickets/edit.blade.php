                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ticket edit</a></li>
                            <li class="breadcrumb-item active">Ticket Edit</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => route('ticket.update', ['ticketId' => $ticket->id]),
                                                'data-method' => 'POST',
                                                'id' => 'dhb-ajax-form',
                                                'files' => true,
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('order_id',$ticket->order_id, ['class' => 'form-control' , 'placeholder'=>'Enter order id']) }}
                        </div>

                        <div class="form-group mb-4">
                            <label class="control-label" id="wrapper_title">Title</label>
                            {{ Form::text('title',$ticket->title, ['class' => 'form-control ' , 'placeholder'=>'Enter ticket title']) }}
                        </div>

                        <div class="form-group mb-4">
                            <label id="wrapper_details">Phone(Optional)</label>

                            {{ Form::text('phone',$ticket->phone, [ 'class'=>'form-control', 'placeholder'=>'phone','rows'=>5]) }}
                        </div>

                        <div class="form-group mb-4">
                            <label id="wrapper_details">Details</label>

                            {{ Form::textarea('details',$ticket->details, ['id'=>'elm1',  'placeholder'=>'Order Details','rows'=>5]) }}
                        </div>
                            ...
                            <div class="" id="wrapper_due_date">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy"
                                           data-provide="datepicker" name="due_date" autocomplete="off" value="{{inputFormat($ticket->due_date)}}">
