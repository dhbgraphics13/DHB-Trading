                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                <div class="text-sm-right">
                                    <a href="{{ route('users.create') }}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Add New </a>
                                </div>
                            </div><!-- end col-->
                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <p> Suggested Passsword <b>{{ AutoGeneratedRandomPassword() }}</b></p>
